...
// -- Challenge 1 -------------------------
// Write a function to return the first title of the
// articles above using only _.get, _.head, and
// _.compose.
    
    
var firstTitle = _.compose(_.get('title'), _.head)
    
assertEqual('Everything Sucks', firstTitle(articles));
